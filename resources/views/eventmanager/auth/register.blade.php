@extends('eventmanager.layout.auth')
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/eventmanager/register') }}">
                        {{ csrf_field() }}

                        <div class="form-group{{ $errors->has('manager_name') ? ' has-error' : '' }}">
                            <label for="manager_name" class="col-md-4 control-label">manager_name</label>

                            <div class="col-md-6">
                                <input id="manager_name" type="text" class="form-control" name="manager_name" value="{{ old('manager_name') }}" autofocus>
