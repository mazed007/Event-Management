...
<div class="container">
  <br>
  <a href="{{route('welcome')}}"><img src ="{{ asset('images/slide/'. 'Previous-icon.png')}}" align="right" height="50" width="50"/></a>
  <h1 class="text-success"><b>Search Result</b></h1>
...
@foreach($confirmbooks as $row)
  ...
  <div class="media-body">
    <h4 class="text-warning">Center Name: {{$row['center_name']}}</h4>
